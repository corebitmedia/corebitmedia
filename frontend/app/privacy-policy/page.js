export const metadata = {
  ...
  description: 'Privacy Policy for Core Bit Media — how we collect, use, and protect your data.'
};

// Verbatim from the live corebitmedia.com/privacy-policy/ page (WordPress
// database export, Aug 2026) — this is the site's own actual published text.
const SECTIONS = [
  {
    heading: 'Who We Are',
    body: 'Our website address is: https://www.corebitmedia.com.'
  },
  {
    heading: 'Comments',
    body: [
